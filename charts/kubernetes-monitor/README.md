...
The chart is released through Octopus as a subchart of the [Kubernetes agent chart](https://github.com/OctopusDeploy/helm-charts/tree/main/charts/kubernetes-agent).

The chart source is in [this directory](.).
...
| --------- | ------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| 0         | [main](https://github.com/OctopusDeploy/kubernetes-monitor/tree/main/charts/kubernetes-monitor)                                        | This file                                                                                                               | [here](./values.yaml)                                                                                                     |
...
| nodeSelector | object | `{"kubernetes.io/os":"linux"}` | Custom node selector for kubernetes monitor pods. |
